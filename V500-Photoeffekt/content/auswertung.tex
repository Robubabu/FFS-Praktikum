...
Nach Formel \eqref{eqn:Z} entspricht somit h/e$= a_\symup{h} = \SI{4.6 \pm 0.9}{\femto \volt \second} $.
...
\begin{table}
  \centering
  \caption{Messwerte der $\lambda = $578 nm Linie}
  \label{tab:orange}
...
\end{table}
  ...
  \begin{table}
    \centering
    \caption{Messwerte der $\lambda = $546 nm Linie}
    \label{tab:gruen}
    \sisetup{round-mode=places}
    \begin{tabular}{S[round-precision = 1]|S[round-precision = 1]}
      \toprule
...
\begin{table}
  \centering
  \caption{Messwerte der $\lambda = $492nm Linie}
  \label{tab:blau1}
  \sisetup{round-mode=places}
  \begin{tabular}{S[round-precision = 1]|S[round-precision = 1]}
    \toprule
...
\begin{table}
  \centering
  \caption{Messwerte der $\lambda = $436nm Linie}
  \label{tab:blau2}
  \sisetup{round-mode=places}
  \begin{tabular}{S[round-precision = 1]|S[round-precision = 1]}
    \toprule
